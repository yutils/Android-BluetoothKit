...
public class PullToRefreshFrameLayout extends FrameLayout {
    ...
    private void Init() {
        ...
        pullToRefreshListView = findViewById(R.id.timeline_list);
        ...
        mBackGroudLayout = findViewById(R.id.pull_to_refresh_layout);
        loadLayout = findViewById(R.id.loading_layout);
//		loadLayout = (ImageView) findViewById(R.id.loading_img);
        errorLayout = findViewById(R.id.error_layout);
        emptyLayout = findViewById(R.id.empty_layout);
        mEmptyImageView = findViewById(R.id.empty_img);
        mShadowTop = findViewById(R.id.list_top_shadow);
        mShadowBottom = findViewById(R.id.list_bottom_shadow);
        mLoadingImg = findViewById(R.id.loading_img);
        mTips = findViewById(R.id.empty_text_notice);
        if (hasShadow) {
