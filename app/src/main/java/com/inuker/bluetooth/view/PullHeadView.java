...
public class PullHeadView extends ViewGroup {
    ...
    private void initView(Context context) {
        ...
        pbRefreshing = findViewById(R.id.pb_refresh);
        ivArrow = findViewById(R.id.imageview_refresh);
        tvRefreshText = findViewById(R.id.tv_pull_to_refresh_text);
        tvRefreshTime = findViewById(R.id.tv_pull_to_refresh_time);
    ...
    private String getLastTimeLable() {
        if (mTimeTag != null) {
            ...
            return mContext.getString(R.string.string_update_time,
    ...
    public void updateLastTimeLable() {
        if (mTimeTag != null && mTimeTag.length() > 0) {
            ...
            mContext.getSharedPreferences(SP_NAME, 0).edit().putLong(mTimeTag, curTime).commit();
        }
    }
    ...
    private class CloseTimer extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            setHeaderHeight(mInitHeight - mDistance);
        }
